...
setIsLoading(true);
axios
.get("https://namasya.onrender.com/fetchaccessories")
.then((res) => {
...
if (query) {
axios
.get("https://namasya.onrender.com/fetchaccessories", { params: { search: query } })
.then((response) => {
...
export default connect(null, { addToCart })(Accessories);