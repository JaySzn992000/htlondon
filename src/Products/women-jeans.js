...
setIsLoading(true);
axios
.get("https://namasya.onrender.com/fetchwomenjeans")
.then((res) => {
...
if (query) {
axios
.get("https://namasya.onrender.com/fetchwomenjeans", { params: { search: query } })
.then((response) => {
...
export default connect(null, { addToCart })(WomenJeans);