...
const WomenAccessories = ({ addToCart }) => {
...
setIsLoading(true);
axios
.get("https://namasya.onrender.com/fetchwomenacessories")
.then((res) => {
...
if (query) {
axios
.get("https://namasya.onrender.com/fetchwomenacessories", { params: { search: query } })
.then((response) => {
