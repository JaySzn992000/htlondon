...
setIsLoading(true);
axios
.get("https://namasya.onrender.com/fetchtrousers")
.then((res) => {
...
if (query) {
axios
.get("https://namasya.onrender.com/fetchtrousers", { params: { search: query } })
.then((response) => {
...
export default connect(null, { addToCart })(Trousers);